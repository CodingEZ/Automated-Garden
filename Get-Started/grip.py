...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_green = [73.38129496402877, 255.0]
        self.__rgb_threshold_blue = [0.0, 255.0]

        self.rgb_threshold_output = None


        self.__mask_0_mask = self.rgb_threshold_output

        self.mask_0_output = None

        self.__hsl_threshold_input = self.mask_0_output
        self.__hsl_threshold_hue = [21.582734842094585, 180.0]
        ...
        self.__find_contours_input = self.mask_1_output
